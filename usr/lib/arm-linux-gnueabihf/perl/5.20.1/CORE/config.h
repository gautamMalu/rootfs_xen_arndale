...
/* Package name      : perl5
 * Source directory  : .
 * Configuration time: Fri Oct 10 14:53:52 UTC 2014
 * Configured by     : Debian Project
 * Target system     : linux kishi02 3.2.0-68-highbank #102-ubuntu smp preempt tue aug 12 22:53:28 utc 2014 armv7l armv7l armv7l gnulinux 
 */
 ...
 */
#define OSNAME "linux"		/**/
#define OSVERS "3.2.0-68-highbank"		/**/
 ...
 *	in programs that are not prepared to deal with ~ expansion at run-time.
 */
#define SITEARCH "/usr/local/lib/arm-linux-gnueabihf/perl/5.20.1"		/**/
#define SITEARCH_EXP "/usr/local/lib/arm-linux-gnueabihf/perl/5.20.1"		/**/
